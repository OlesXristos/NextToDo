import { getUserFollowers } from '@/action/profile.action';
...
export default async function FollowersPage({ params }: { params: { username: string } }) {
  ...
  if (!followers) notFound();
  return (
    <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 relative ">
      <div className="lg:col-span-10 ">
        <Tabs defaultValue="followers" className=" w-full grid grid-cols-1 ">
                    ...
                    <div
                      ...
                      <div className="flex items-center gap-1">
                        <Link href={`/profile/${user.follower.username}`}>
                          <Avatar>
                            <AvatarImage src={user.follower.image ?? '/avatar.png'} />
                          </Avatar>
                        </Link>
